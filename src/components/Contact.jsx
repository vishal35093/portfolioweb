  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">If you want to contact with me then please fill the form!</p>
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          {/* Add the switch and label for agreement */}
          <div className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              {/* You might need to import a custom switch component here */}
              <input
                type="checkbox"
